...
GO
PRINT N'Creating [dbo].[FK_RentCompanies_Cities]...';


GO
ALTER TABLE [dbo].[RentCompanies] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[RentCompanies] WITH CHECK CHECK CONSTRAINT [FK_RentCompanies_Cities];
